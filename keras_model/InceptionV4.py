"""
source from:https://github.com/titu1994/Inception-v4
description:
  titu1994's version is keras 1.x.x, just moidfy to support keras 2.x.x
  titu1994's github has so many keras useful information.
"""
...
def conv_block(x, nb_filter, kernel_size, padding='same', strides=(1, 1), bias=False):
    if K.image_dim_ordering() == "th":
        channel_axis = 1
    else:
        channel_axis = -1

    x = Conv2D(nb_filter, kernel_size=kernel_size, strides=strides, padding=padding, use_bias=bias)(x)
